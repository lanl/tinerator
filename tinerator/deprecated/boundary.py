...
def imageErosionBoundary(
    A, nil_value, distance, cell_size=None, xll_corner=0, yll_corner=0
):
    """
    ...
    if cell_size is not None:
        ...
        xy[:, 1] = yVectorToProjection(
            xy[:, 1], cell_size, yll_corner, np.shape(A)[0]
        )
...
def squareTraceBoundary(A, NDV, dist=10.0):
    """
    ...
    cfg.log.info(
        "C T. Pavlidis, Algorithms for Graphics and Image Processing, Computer Science Press, Rockville, Maryland, 1982"
    )
