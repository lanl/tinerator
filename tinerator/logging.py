...
def debug(msg: str, **kwargs):
    ...
    log(_wrap_format(msg, console_opts["debug_format"]), log_level = LogLevel.DEBUG, **kwargs)

def warn(msg: str, **kwargs):
    '''Writes a warning message to the logger.'''
    log(_wrap_format(msg, console_opts["warning_format"]), log_level = LogLevel.WARN, **kwargs)

def error(msg: str, **kwargs):
    '''Writes an error message to the logger.'''
    log(_wrap_format(msg, console_opts["error_format"]), log_level = LogLevel.ERROR, **kwargs)